...
export class CircleAnnotationObj extends CircleSquareAnnotationObj {
    ...
    public createDefaultAppearanceStream() {
        ...
        go.setLineColor(this.color).setFillColor(this.fill).drawFillCircle(this.rect[0], this.rect[1], this.rect[2], this.rect[3])
...
export class SquareAnnotationObj extends CircleSquareAnnotationObj {
    ...
    public createDefaultAppearanceStream() {
        ...
        if(this.color) {
            go.setLineColor(this.color).drawBolderStyle(this.border?.border_style);
        }

        if(this.fill) {
            go.setFillColor(this.fill).drawFillRect(this.rect[0], this.rect[1], this.rect[2], this.rect[3], 0, this.border?.border_width);
        } else {
            go.drawRect(this.rect[0], this.rect[1], this.rect[2], this.rect[3], 0, this.border?.border_width);
        }
