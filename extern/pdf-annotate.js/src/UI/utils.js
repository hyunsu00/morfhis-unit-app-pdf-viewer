...
export function addComment(documentId, annotationId, content, dataString, author) {
  return fireEvent('annotation:addComment', documentId, annotationId, content, dataString, author);
}
